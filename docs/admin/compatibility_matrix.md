...
|---------------------------|-----------------|-----------------|--------|--------|
| 2.0.x | 3.0.0 | 3.x | 3.10–3.12 | Current (latest: 2.0.10) |
| 1.1.8 | 3.0.0 | 3.x | 3.10–3.12 | Supported |
| 1.1.x | 3.0.0 | 3.x | 3.10–3.12 | Deprecated |
| 1.0.x | 3.0.0 | 3.x | ≥ 3.10 | Deprecated |
| 0.5.x | 3.0.0 | 3.x | ≥ 3.10 | End of Life |
| 0.4.x | 3.0.0 | 3.x | ≥ 3.10 | End of Life |
