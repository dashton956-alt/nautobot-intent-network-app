...
```no-highlight
> poetry version
intent-networking 1.0.0-beta.2
```
...
Draft a [new release](https://github.com/dashton956-alt/natuobot-iintent-network-app/releases/new) with the following parameters.
...
- Change the entries generated by GitHub to only the usernames of the contributors. e.g. `* Updated dockerfile by @nautobot_user in https://github.com/dashton956-alt/natuobot-iintent-network-app/pull/123` -> `* @nautobot_user`.
...
**Full Changelog**: https://github.com/dashton956-alt/natuobot-iintent-network-app/compare/v1.4.1...v1.4.2
```
