...
for pfx_str in PREFIXES:
    Prefix.objects.get_or_create(prefix=pfx_str, defaults={"namespace": ns, "status": active})
    ...
    "bos-pe01": {
        ...
        "interfaces": [
            ...
            (
                ...
                False,
                None,
                "SPARE — reserved for DC expansion",
                9214,
                "00:1A:2B:10:00:03",
                10000000,
            ),
    ...
    "sea-pe01": {
        ...
        "interfaces": [
            ...
            (
                ...
                True,
                None,
                "TO lon-pe01 Gi0/0/0/0 (transatlantic)",
                9214,
                "00:1A:2B:31:00:02",
                10000000,
            ),
    ...
    "lon-pe01": {
        ...
        "interfaces": [
            ...
            (
                ...
                True,
                None,
                "TO sea-pe01 Ethernet2 (transatlantic)",
                9214,
                "00:1A:2B:40:00:01",
                10000000,
            ),
